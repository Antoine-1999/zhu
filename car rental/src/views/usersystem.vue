<template>
  <div style="width: 88%; margin-top: 10px">
    ...
    <el-table fit :data="userList" style="width: 80%; margin-left: 20px">
      <el-table-column disable prop="username" label="用户名" width="180">
      </el-table-column>
      ...
      <el-table-column prop="administrator" label="身份" width="120"> </el-table-column>
  ...
  methods: {
    ...
    UserModifyEdit() {
      ...
      if (name == "" || sex == "" || phone == "" || email == "" || administrator == "") {
        ...
        axios
          .patch("http://localhost:3000/userlist/" + modifyuser.id, modifyuser)
          .then((res) => {
    ...
    Query() {
      ...
      axios
        ...
        .then(function (res) {
          const { status, data } = res;
          if (status === 200) that.userList = data;
        }) // 成功时的回调
