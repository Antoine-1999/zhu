  ...
  <div class="AddDate">
    <el-card shadow="always">
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" v-show="AddForm.isAdd" @click="Add('AddForm')"
            >确 定</el-button
          >
          <el-button @click="resetForm('AddForm')" v-show="AddForm.isAdd"
            >重 置</el-button
          >
          <el-button type="primary" v-show="AddForm.isShow" @click="Edit"
            >保 存</el-button
          >
