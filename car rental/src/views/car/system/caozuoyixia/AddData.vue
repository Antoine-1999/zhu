<template>
  ...
  >
    ...
    <el-form-item
      label="汽车型号"
      prop="style"
      style="margin-left: 30%; margin-top: -560px"
    >
    ...
    <el-form-item
      label="汽车名称"
      prop="name"
      style="margin-left: 30%; margin-top: -500px"
    >
    ...
    <el-form-item
      label="汽车颜色"
      prop="color"
      style="margin-left: 30%; margin-top: -430px"
    >
    ...
    <el-form-item
      label="日租价格"
      prop="ppd"
      style="margin-left: 30%; margin-top: -360px"
    >
    ...
    <el-form-item
      label="月租价格"
      prop="ppm"
      style="margin-left: 30%; margin-top: -290px"
    >
      ...
      <el-col :span="11">
        <el-form-item prop="date1">
          <el-date-picker
            ...
            style="width: 221.4px; margin-top: -150px"
          ></el-date-picker>
        </el-form-item>
      </el-col>
    </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, message: "请输入汽车名称", trigger: "blur" }],
        region: [{ required: true, message: "请选择汽车品牌", trigger: "change" }],
        ppd: [
          {
            required: true,
            message: "请输入日租价格",
        ...
        ppm: [{ required: true, message: "请输入月租价格", trigger: "blur" }],
        date1: [
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (this.ruleForm.region == "Benz") {
            ...
            axios
              .post("http://localhost:3000/FAW-VK", {
                carNo: this.ruleForm.style,
                carName: this.ruleForm.name,
                carColor: this.ruleForm.color,
                PricePerDay: this.ruleForm.ppd,
            ...
            axios
              .post("http://localhost:3000/Nissan", {
                carNo: this.ruleForm.style,
                carName: this.ruleForm.name,
                carColor: this.ruleForm.color,
                PricePerDay: this.ruleForm.ppd,
