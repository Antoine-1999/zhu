  ...
  methods: {
    search() {
      if (this.userForm.region == "Benz") {
        axios.get("http://localhost:3000/Benz").then((res) => {
          console.log(this.userForm.userName);
          console.log(res);
          this.tableData = res.data;
        });
      } else if (this.userForm.region == "BMW") {
        axios.get("http://localhost:3000/BMW").then((res) => {
          console.log(this.userForm.userName);
          console.log(res);
          this.tableData = res.data;
        });
      } else if (this.userForm.region == "Nissan") {
        axios.get("http://localhost:3000/Nissan").then((res) => {
          console.log(this.userForm.userName);
          console.log(res);
          this.tableData = res.data;
        });
      } else if (this.userForm.region == "FAW-VK") {
        axios.get("http://localhost:3000/FAW-VK").then((res) => {
          console.log(this.userForm.userName);
          console.log(res);
          this.tableData = res.data;
        });
    ...
    del(ID) {
      if (this.userForm.region == "Benz") {
        axios.delete("http://localhost:3000/Benz/" + ID).then((res) => {
          const { status, data } = res;
          if (status === 200) {
            axios.get("http://localhost:3000/Benz").then((res) => {
              console.log(this.userForm.userName);
        ...
        axios.delete("http://localhost:3000/BMW/" + ID).then((res) => {
          const { status, data } = res;
          if (status === 200) {
            axios.get("http://localhost:3000/BMW").then((res) => {
              console.log(this.userForm.userName);
        ...
        axios.delete("http://localhost:3000/Nissan/" + ID).then((res) => {
          const { status, data } = res;
          if (status === 200) {
            axios.get("http://localhost:3000/Nissan").then((res) => {
              console.log(this.userForm.userName);
        ...
        axios.delete("http://localhost:3000/FAW-VK/" + ID).then((res) => {
          const { status, data } = res;
          if (status === 200) {
            axios.get("http://localhost:3000/FAW-VK").then((res) => {
              console.log(this.userForm.userName);
