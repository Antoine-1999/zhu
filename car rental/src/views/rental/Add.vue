  ...
  <el-form :model="indent" :rules="rules" label-width="80px">
    ...
    <div class="car">
      ...
      >
        ...
        <el-table :data="carport" style="width: 60%">
          <el-table-column prop="type" label="车型"> </el-table-column>
          <el-table-column prop="num" label="车牌"> </el-table-column>
    ...
    <div class="indent">
      ...
      <span
        ...
        >{{ indent.date[0] + "-" + indent.date[1] }}</span
      >
      <span
        ><i class="el-icon-coin"></i>{{ indent.sumrent + "元" }}({{
          indent.rent + "元/天"
        }})</span
      >
      <div class="btn">
...
export default {
  ...
  methods: {
    ...
    change() {
      //计算选择日期与当前日期的天数差
      var day = parseInt(
        (Date.parse(this.indent.date[1]) - Date.parse(this.indent.date[0])) /
          1000 /
          60 /
          60 /
          24
